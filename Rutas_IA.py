...
estaciones_df = pd.read_csv('dataset/SITP.csv') 

# Limpiar los nombres de las columnas
estaciones_df.columns = estaciones_df.columns.str.strip()


# Creamos un dataframe de conexiones
...
# Se estima un caso hipotetico donde la duracion del viaje es de 2 minutos x km
rutas_df['Duración'] = rutas_df['Distancia'] * 2  

# Procesar el dataset para el modelo
...
joblib.dump(model, 'Duracion_viaje.pkl')